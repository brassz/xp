...
CREATE TABLE IF NOT EXISTS payments (
    ...
    payment_type TEXT DEFAULT 'dinheiro' CHECK (payment_type IN ('dinheiro', 'pix', 'cartao', 'partial', 'full', 'interest', 'principal', 'adjustment', 'renewal', 'interest_renewal', 'capital_payment', 'partial_interest')),
    notes TEXT,
    created_by UUID REFERENCES users(id),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
