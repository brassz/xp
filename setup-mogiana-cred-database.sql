-- =====================================================
-- CONFIGURAÇÃO DO BANCO DE DADOS MOGIANA CRED
-- =====================================================
-- Execute estes comandos no SQL Editor do Supabase da MOGIANA CRED
...
COMMENT ON TABLE users IS 'Tabela para armazenar usuários do sistema - MOGIANA CRED';
...
COMMENT ON TABLE clients IS 'Tabela para armazenar clientes - MOGIANA CRED';
...
COMMENT ON TABLE loans IS 'Tabela para armazenar empréstimos - MOGIANA CRED';
...
-- Inserir usuário admin padrão para MOGIANA CRED
INSERT INTO users (email, password_hash, full_name, role, is_active)
VALUES (
    'admin@mogianacred.com',
...
-- =====================================================
-- FIM DA CONFIGURAÇÃO MOGIANA CRED
-- =====================================================
-- 
-- Para executar este script:
-- 1. Acesse o SQL Editor no Supabase da MOGIANA CRED
...
--
-- USUÁRIO ADMIN PADRÃO MOGIANA CRED:
-- Email: admin@mogianacred.com
-- Senha: 1020
-- =====================================================