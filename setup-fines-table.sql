...
-- Exemplo 1: Criar uma multa por atraso de pagamento
/*
INSERT INTO fines (
    client_id, 
    loan_id, 
...
-- Exemplo 2: Registrar pagamento de multa
/*
UPDATE fines 
SET 
    paid_amount = 50.00,
    ...
    notes = 'Multa paga integralmente'
WHERE id = 'FINE_UUID_HERE';
*/

-- Exemplo 3: Ver histórico completo de pagamentos de um cliente
/*
SELECT * FROM client_payment_history
WHERE client_id = 'CLIENT_UUID_HERE'
ORDER BY transaction_date DESC;
*/

-- Exemplo 4: Ver todas as multas pendentes
/*
SELECT * FROM pending_fines;
*/

-- Exemplo 5: Ver resumo de multas por cliente
/*
SELECT * FROM client_fines_summary
WHERE total_outstanding_amount > 0;
*/

-- Exemplo 6: Calcular multa automaticamente
/*
SELECT calculate_late_fine('LOAN_UUID_HERE', 5, 0.02) as multa_calculada;
*/
